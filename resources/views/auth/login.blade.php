...
@section('title', 'Вход')
@section('auth-title', 'Вход в систему')
@section('auth-subtitle', 'Введите ваши учётные данные для входа')
...
@section('content')
    ...
    <form method="POST" action="{{ route('admin.login') }}">
        ...
        <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 24px;">
            <label style="display: flex; align-items: center; gap: 8px; cursor: pointer;">
                <input type="checkbox" name="remember" style="width: 16px; height: 16px; accent-color: #E52716;">
                <span style="font-size: 14px; color: #6B7280;">Запомнить меня</span>
            </label>
        </div>

        <button type="submit" style="width: 100%; padding: 14px 24px; background: linear-gradient(135deg, #E52716 0%, #C41E10 100%); color: #fff; border: none; border-radius: 10px; font-size: 16px; font-weight: 600; cursor: pointer; transition: all 0.2s; box-shadow: 0 4px 15px rgba(229, 39, 22, 0.3);"
                onmouseover="this.style.transform='translateY(-2px)'; this.style.boxShadow='0 6px 20px rgba(229, 39, 22, 0.4)';"
                onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 15px rgba(229, 39, 22, 0.3)';">
    ...
    <div style="margin-top: 24px; padding-top: 20px; border-top: 1px solid #E5E7EB; text-align: center; display: flex; flex-direction: column; gap: 10px;">
        <p style="font-size: 13px; color: #9CA3AF; margin: 0;">
            ...
            Доступ только для HR и администраторов
        </p>
